                            ...
                            <div id="modalBody2" class="modal-body">
                                <form id="createEventForm" novalidate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="eventOrganizer" id="eventOrganizer" class="form-control select2" required>
                                            <option value="" disabled selected>Select Organizer</option>
                                            @foreach($participents as $participent)
                                            <option value="{{$participent->id}}">{{$participent->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="eventParticipants" id="eventParticipants" class="form-control select2" multiple required>
