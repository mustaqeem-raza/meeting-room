        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="languageDropdown">
                    ...
                    <a href="javascript:;" class="dropdown-item py-2">
                        <i class="flag-icon flag-icon-pk" title="pk" id="pk"></i>
                        <span class="ml-1"> اردو </span>
                    </a>
            ...
            @php
            $user = auth()->user();
            $profileImage = $user->image && Storage::exists($user->image)
            ? Storage::url($user->image)
            : 'https://via.placeholder.com/80x80';
            @endphp
            <li class="nav-item dropdown nav-profile">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{$profileImage}}" alt="userr">
                </a>
